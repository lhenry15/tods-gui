...
from tods.timeseries_processing.HoltSmoothing import *

class OWSKHoltSmoothing(SingleInputWidget):
    name = "HoltSmoothing"
    description = ("HoltSmoothing")
    ...
    primitive = HoltSmoothingPrimitive
