...
from tods.timeseries_processing.HoltWintersExponentialSmoothing import *

class OWSKHoltWinter(SingleInputWidget):
    name = "HoltWinter"
    description = ("HoltWinter")
    icon = "icons/HoltSmoothing.svg"
    ...
    primitive = HoltWintersExponentialSmoothingPrimitive
    ...
    def _init_ui(self):
        ...
        gui.checkBox(box, self, "with_std", label='seasonal',  callback=None)
