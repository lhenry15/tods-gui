...
class OWStatisticalGmean(SingleInputWidget):
    name = "StatisticalGmean"
    description = ("Statistical Gmean For feature Analysis.")
...
if __name__ == "__main__":
    WidgetPreview(OWStatisticalGmean).run(Orange.data.Table("iris"))