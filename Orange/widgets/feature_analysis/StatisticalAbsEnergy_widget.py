...
class OWStatisticalAbsEnergy(SingleInputWidget):
    name = "StatisticalAbsEnergy"
    description = ("Statistical Absolute Energy For feature Analysis.")
    icon = "icons/AbsEnergy.svg"
...
if __name__ == "__main__":
    WidgetPreview(OWStatisticalAbsEnergy).run(Orange.data.Table("iris"))