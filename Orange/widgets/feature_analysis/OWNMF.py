...
class OWNMF(SingleInputWidget):
    name = "NMF"
    description = ("Computes Non Negative MAtrix Factorization for give columns and produces column and row vector like PCA")
    icon = "icons/NMF.svg"
...
if __name__ == "__main__":
    WidgetPreview(OWNMF).run(Orange.data.Table("iris"))   
