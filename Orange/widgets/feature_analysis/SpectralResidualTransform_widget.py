...
from tods.feature_analysis.SpectralResidualTransform import *
...
class OWSpectralResidualTransform(SingleInputWidget):
    ...
    def _init_ui(self):
        ...
        gui.lineEdit(box, self, 'avg_filter_dimension', label='The square filter dimension. (IntVariable)', callback=None)
...
if __name__ == "__main__":
    WidgetPreview(OWSpectralResidualTransform).run(Orange.data.Table("iris"))