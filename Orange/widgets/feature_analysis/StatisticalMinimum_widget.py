...
from tods.feature_analysis.StatisticalMinimum import *

class OWStatisticalMinimum(SingleInputWidget):
    name = "StatisticalMinimum"
    description = ("Statistical Minimum For feature Analysis.")
    icon = "icons/Minimum.svg"
    ...
    primitive = StatisticalMinimumPrimitive
...
if __name__ == "__main__":
    WidgetPreview(OWStatisticalMinimum).run(Orange.data.Table("iris"))