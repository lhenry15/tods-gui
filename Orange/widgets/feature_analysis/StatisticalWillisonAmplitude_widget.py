...
class OWStatisticalWillisonAmplitude(SingleInputWidget):
    name = "StatisticalWillisonAmplitude"
    description = ("Statistical WillisonAmplitude For feature Analysis.")
    icon = "icons/WillisonAmplitude.svg"
...
if __name__ == "__main__":
    WidgetPreview(OWStatisticalWillisonAmplitude).run(Orange.data.Table("iris"))