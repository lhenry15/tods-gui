...
class OWStatisticalZeroCrossing(SingleInputWidget):
    name = "StatisticalZeroCrossing"
    description = ("Statistical Zero Crossing For feature Analysis.")
    icon = "icons/ZeroCrossing.svg"
...
if __name__ == "__main__":
    WidgetPreview(OWStatisticalZeroCrossing).run(Orange.data.Table("iris"))