...
from tods.feature_analysis.StatisticalMean import *

class OWStatisticalMean(SingleInputWidget):
    name = "StatisticalMean"
    description = ("Statistical Mean For feature Analysis.")
    icon = "icons/Mean.svg"
    ...
    primitive = StatisticalMeanPrimitive
...
if __name__ == "__main__":
    WidgetPreview(OWStatisticalMean).run(Orange.data.Table("iris"))