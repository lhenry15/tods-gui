...
from tods.feature_analysis.StatisticalMaximum import *

class OWStatisticalMaximum(SingleInputWidget):
    name = "StatisticalMaximum"
    description = ("Statistical Maximum For feature Analysis.")
    icon = "icons/Maximum.svg"
    ...
    primitive = StatisticalMaximumPrimitive
...
if __name__ == "__main__":
    WidgetPreview(OWStatisticalMaximum).run(Orange.data.Table("iris"))