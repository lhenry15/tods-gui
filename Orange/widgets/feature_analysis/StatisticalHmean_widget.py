...
class OWStatisticalHmean(SingleInputWidget):
    name = "StatisticalHmean"
    description = ("Statistical Hmean For feature Analysis.")
...
if __name__ == "__main__":
    WidgetPreview(OWStatisticalHmean).run(Orange.data.Table("iris"))