...
class OWStatisticalVecSum(SingleInputWidget):
    name = "StatisticalVecSum"
    description = ("Statistical VecSum For feature Analysis.")
    icon = "icons/VecSum.svg"
...
if __name__ == "__main__":
    WidgetPreview(OWStatisticalVecSum).run(Orange.data.Table("iris"))