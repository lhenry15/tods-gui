...
from tods.feature_analysis.StatisticalSkew import *

class OWStatisticalSkew(SingleInputWidget):
    name = "StatisticalSkew"
    description = ("Statistical Skew For feature Analysis.")
    icon = "icons/Skew.svg"
    ...
    primitive = StatisticalSkewPrimitive
...
if __name__ == "__main__":
    WidgetPreview(OWStatisticalSkew).run(Orange.data.Table("iris"))