...
class OWStatisticalMeanAbsTemporalDerivative(SingleInputWidget):
    name = "StatisticalMeanAbsTemporalDerivative"
    description = ("Statistical Mean Abs Temporal Derivative For feature Analysis.")
...
if __name__ == "__main__":
    WidgetPreview(OWStatisticalMeanAbsTemporalDerivative).run(Orange.data.Table("iris"))