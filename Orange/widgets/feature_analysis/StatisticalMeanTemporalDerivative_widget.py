...
from tods.feature_analysis.StatisticalMeanTemporalDerivative import *

class OWStatisticalMeanTemporalDerivative(SingleInputWidget):
    name = "StatisticalMeanTemporalDerivative"
    description = ("Statistical Mean Temporal Derivative For feature Analysis.")
    icon = "icons/MeanTemporalDerivative.svg"
    ...
    primitive = StatisticalMeanTemporalDerivativePrimitive
...
if __name__ == "__main__":
    WidgetPreview(OWStatisticalMeanTemporalDerivative).run(Orange.data.Table("iris"))