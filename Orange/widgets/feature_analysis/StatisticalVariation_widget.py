...
from tods.feature_analysis.StatisticalVariation import *

class OWStatisticalVariation(SingleInputWidget):
    name = "StatisticalVariation"
    description = ("Statistical Variation For feature Analysis.")
    icon = "icons/Variation.svg"
    ...
    primitive = StatisticalVariationPrimitive
...
if __name__ == "__main__":
    WidgetPreview(OWStatisticalVariation).run(Orange.data.Table("iris"))