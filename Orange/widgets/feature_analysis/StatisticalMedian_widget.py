...
from tods.feature_analysis.StatisticalMedian import *

class OWStatisticalMedian(SingleInputWidget):
    name = "StatisticalMedian"
    description = ("Statistical Median For feature Analysis.")
    icon = "icons/Median.svg"
    ...
    primitive = StatisticalMedianPrimitive
...
if __name__ == "__main__":
    WidgetPreview(OWStatisticalMedian).run(Orange.data.Table("iris"))