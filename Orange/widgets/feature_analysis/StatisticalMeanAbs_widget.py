...
class OWStatisticalMeanAbs(SingleInputWidget):
    name = "StatisticalMeanAbs"
    description = ("Statistical MeanAbs For feature Analysis.")
...
if __name__ == "__main__":
    WidgetPreview(OWStatisticalMeanAbs).run(Orange.data.Table("iris"))