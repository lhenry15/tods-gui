...
class OWStatisticalKurtosis(SingleInputWidget):
    name = "StatisticalKurtosis"
    description = ("Statistical Kurtosis For feature Analysis.")
...
if __name__ == "__main__":
    WidgetPreview(OWStatisticalKurtosis).run(Orange.data.Table("iris"))