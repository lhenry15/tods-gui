...
from tods.feature_analysis.StatisticalMedianAbsoluteDeviation import *

class OWStatisticalMedianAbsoluteDeviation(SingleInputWidget):
    name = "StatisticalMedianAbsoluteDeviation"
    description = ("Statistical MedianAbsoluteDeviation For feature Analysis.")
    icon = "icons/MedianAbsDeviation.svg"
    ...
    primitive = StatisticalMedianAbsoluteDeviationPrimitive
...
if __name__ == "__main__":
    WidgetPreview(OWStatisticalMedianAbsoluteDeviation).run(Orange.data.Table("iris"))