...
class OWStatisticalAbsSum(SingleInputWidget):
    name = "StatisticalAbsSum"
    description = ("Statistical Absolute Sum For feature Analysis.")
    icon = "icons/AbsSum.svg"
...
if __name__ == "__main__":
    WidgetPreview(OWStatisticalAbsSum).run(Orange.data.Table("iris"))