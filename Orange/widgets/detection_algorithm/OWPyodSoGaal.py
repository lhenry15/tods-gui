...
from tods.detection_algorithm.PyodSoGaal import *

class OWPyodSoGaal(SingleInputWidget):
    name = "PyodSoGaal"
    description = ("SoGaal for outlier detection.")
    icon = "icons/SoGaal.svg"
...
if __name__ == "__main__":
    WidgetPreview(OWPyodSoGaal).run(Orange.data.Table("iris"))