...
from tods.detection_algorithm.PyodVAE import *

class OWPyodVAE(SingleInputWidget):
    name = "OWPyodVAE"
    description = ('Unsupervised Outlier Detection using variational autoencoder')
    ...
    primitive = VariationalAutoEncoderPrimitive
    ...
    def _init_ui(self):
        ...
        gui.lineEdit(line2, self, 'encoder_neurons', label='encoder_neurons')
