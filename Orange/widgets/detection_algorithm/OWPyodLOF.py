...
from tods.detection_algorithm.PyodLOF import *

class OWPyodLOF(SingleInputWidget):
    name = "PyodLOF"
    description = ("Unsupervised Outlier Detection using Local Outlier Factor (LOF).")
    icon = "icons/local_outlier_factor.svg"
