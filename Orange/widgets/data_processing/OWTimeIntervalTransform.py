...
from tods.data_processing.TimeIntervalTransform import *

class OWTimeIntervalTransform(SingleInputWidget):
    name = "Time Interval Transform"
    description = ("Time Interval Transform.")
    icon = "icons/TimeIntervalTransform.svg"
    ...
    hyperparameter_list = ['time_interval',
    						'use_columns',
    						'exclude_columns',
    						'return_result',
    						'use_semantic_types',
    ...
    primitive = TimeIntervalTransformPrimitive
    ...
    def _init_ui(self):
        ...
        gui.lineEdit(box, self, 'time_interval', label='Time interval to sample', callback=self.settings_changed)
