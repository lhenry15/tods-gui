...
from tods.data_processing.CategoricalToBinary import *

class OWCAT2B(SingleInputWidget):
    name = "Categorical2Binary"
    description = ("Coverts a column to binary version like one hot encoding")
    icon = "icons/C2B.svg"
    ...
    primitive = CategoricalToBinaryPrimitive
...
if __name__ == "__main__":
    WidgetPreview(OWCAT2B).run(Orange.data.Table("iris"))   
